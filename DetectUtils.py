...
def initYOLOModel(task:str = 'object'):
    ...
    if task == 'object':
        ## YOLOv5模型
        model = DetectMultiBackend(weights='D:/User/Documents/Code/Encryption/Transfrom/ED_YoloV5/weights/yolov5s.pt',
                                    data='D:/User/Documents/Github/yolov5/data/coco.yaml', device=device)
    elif task == 'segment':
        model = DetectMultiBackend(weights='D:/User/Documents/Code/Encryption/Transfrom/ED_YoloV5/weights/yolov5x-seg.pt', device=device,
